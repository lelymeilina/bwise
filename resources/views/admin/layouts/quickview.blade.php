                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            ...
                            {{ Html::image('assets/theme/assets/img/profiles/1x.jpg', '', ['data-src'=>'assets/theme/assets/img/profiles/1.jpg', 'data-src-retina'=>'assets/theme/assets/img/profiles/1x.jpg', 'width'=>'34', 'height'=>'34']) }}
                        </span>
                        <p class="p-l-10 ">
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            ...
                            {{ Html::image('assets/theme/assets/img/profiles/2x.jpg', '', ['data-src'=>'assets/theme/assets/img/profiles/2.jpg', 'data-src-retina'=>'assets/theme/assets/img/profiles/2x.jpg', 'width'=>'34', 'height'=>'34']) }}
                        </span>
                        <p class="p-l-10 ">
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            ...
                            {{ Html::image('assets/theme/assets/img/profiles/3x.jpg', '', ['data-src'=>'assets/theme/assets/img/profiles/3.jpg', 'data-src-retina'=>'assets/theme/assets/img/profiles/3x.jpg', 'width'=>'34', 'height'=>'34']) }}
                        </span>
                        <p class="p-l-10 ">
              ...
              <div class="chat-inner" id="my-conversation">
                ...
                <div class="message clearfix">
                  <div class="profile-img-wrapper m-t-5 inline">
                    ...
                    {{ Html::image('assets/theme/assets/img/profiles/avatar_small.jpg', '', ['class'=>'col-top', 'data-src'=>'assets/theme/assets/img/profiles/avatar_small.jpg', 'data-src-retina'=>'assets/theme/assets/img/profiles/avatar_small2x.jpg', 'width'=>'30', 'height'=>'30']) }}
                  </div>
